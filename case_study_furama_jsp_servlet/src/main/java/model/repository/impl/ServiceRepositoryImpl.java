...
public class ServiceRepositoryImpl implements IServiceRepository {
    ...
    private static final String INSERT_SERVICE_SQL = "INSERT INTO service (service_code, service_name, service_area, service_cost, " +
        ...
        if (connection != null) {
            try {
                ...
                while (resultSet.next()) {
                    ...
                    service = new Service(id, serviceCode, name, area, cost, maxPeople, rentTypeId, serviceTypeId, standardRoom,
